...
SET MAINCLASSSRC6=src/gameOfLife_COntroller/GameController.java
SET MAINCLASSSRC7=src/gameOflife_View/GameView.java
SET MAINCLASSSRC8=src/turingMachine_Controller/TuringController.java
SET MAINCLASSSRC9=src/turingMachine_Main/turingMachine_Config.java
SET MAINCLASSSRC10=src/turingMachine_Main/turingMachine_Server.java
SET MAINCLASSSRC11=src/turingMachine_Main/turingMachine_User.java
SET MAINCLASSSRC12=src/turingMachine_Model/TuringMachine.java
SET MAINCLASSSRC13=src/turingMachine_View/TuringView.java
